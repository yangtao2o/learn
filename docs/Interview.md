...
所谓验证码，就是将一串随机产生的数字或符号，生成一幅图片， 图片里加上一些干扰象素（防止 OCR），由用户肉眼识别其中的验证码信息，输入表单提交网站验证，验证成功后才能使用某项功能。
...
对于新人来说，JavaScript 的原型是一个很让人头疼的事情，一来 prototype 容易与 \_**\_proto\_\_** 混淆，
...
console.log(
  "a3.__proto__ === a3.constructor.prototype：",
  a3.__proto__ === a3.constructor.prototype
); // false（此处即为图1中的例外情况）
```
...
2. [JS 类型判断---typeof, constructor, instanceof, toString](https://juejin.im/post/5d99b56f518825222b5b6737)
...
- [常见六大 Web 安全攻防解析](https://juejin.im/post/5c446eb1e51d45517624f7db)
...
- [JavaScript 之 bind 及 bind 的模拟实现](https://blog.csdn.net/c__dreamer/article/details/79673725)
- [Http Cookie 机制及 Cookie 的实现原理](https://blog.csdn.net/aa5305123/article/details/83247041)
- [一个 dom,点击事件触发两个事件是同步还是异步](https://blog.csdn.net/u012129607/article/details/78117483)
- [16 种 JavaScript 设计模式（中）](https://juejin.im/post/5c038df96fb9a04a0378f600)
...
[ES6 函数默认参数](https://www.jianshu.com/p/e4ea0d43529c)
...
- [(纯干货)HTTP／1.0／1.1／2.0 的区别以及 http 和 https 的区别](https://www.cnblogs.com/NightTiger/p/11334314.html)
...
它允许我们提取数组和对象的值，对变量进行赋值  （旧版本浏览器不能使用 ES6 语法）。
